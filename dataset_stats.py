...
#main function to extract statdistics from the dataset, test not use
def main(X_train, X_test, y_train, y_test):
    dic_words_sar = {}
    dic_words_nsar = {}
    list_len_sar=[]
    list_len_nsar = []
    #get some stats from the dataset for plotting later on
    ...
    # see what is the overlap between the two classes
    ...
    #plot the most common word in both classes
